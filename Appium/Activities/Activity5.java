...
public class Activity5 {
    ...
    public void smsTest() {
        ...
        driver.findElement(AppiumBy.accessibilityId("Start the chat")).click();
        ...
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@resource-id='ContactSearchField']")).sendKeys("9988776655");
        // Press ENTER
        ...
        // Enter text to send
        driver.findElement(AppiumBy.id("com.google.android.apps.messaging:id/compose_message_text")).sendKeys("Welcome to Appium");
        // Press Send
        ...
        Assert.assertEquals(messageTextSent, "Welcome to Appium");
    }
